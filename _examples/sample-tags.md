...
- `personal/tags.md` — applies to every session in this workbench
- `personal/projects/<name>/tags.md` — applies only when that project context is active (takes precedence over the top-level file)
